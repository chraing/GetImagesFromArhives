...
from  archives import GetFromCgamos,GetFromYandexArhive,GetFromKaluga,GetFromTula,GetFromVladimir,GetFromGenoDbase
                    ...
                    for n,trs_rec in enumerate(settings.trs):
                        ...
                        if complete==False:
                            if request.form.get('arhiv')=='cgamos.ru':
                                ...
                                f=GetFromVladimir
                            elif request.form.get('arhiv')=='geno-dbase.ru':
                                f=GetFromGenoDbase                     
